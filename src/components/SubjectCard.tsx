...
const SubjectCard = ({ subject, index }: SubjectCardProps) => {
  ...
  return (
    <>
      ...
      {/* Drawers */}
      <QuizDrawer isOpen={quizOpen} onClose={() => setQuizOpen(false)} subject={subject} />
      <PYQDrawer isOpen={pyqOpen} onClose={() => setPyqOpen(false)} subject={subject} />
      <TopicsDrawer isOpen={topicsOpen} onClose={() => setTopicsOpen(false)} subject={subject} />
    </>
  );
};
